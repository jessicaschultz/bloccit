  ...
  context "signed-in user" do
    ...
    describe "GET edit" do
      ...
      it "renders the #edit view" do
        ## CHECKPOINT Q: WHY NOT WRAP THE TOPIC_ID: IN PARAMS: LIKE ABOVE?
        ## UPDATE: WRITING IT LIKE CHECKPOINT SPECIFIES (get :edit, topic_id: my_topic.id, id: my_post.id) THROWS ARGUMENT ERROR UNKNOW KEYWORDS: TOPIC_ID, ID.
        ## UPDATE: FIXED ERROR BY WRAPPING IN PARAMS
        get :edit, params: {topic_id: my_topic.id, id: my_post.id}
